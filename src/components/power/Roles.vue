  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="rolesList" border stripe>
        ...
        <el-table-column type="expand">
          <template slot-scope="scope">
            <el-row  class="vcenter" :class="['bdbottom',i1 === 0 ? 'bdtop':'' ]" v-for="(item1, i1) in scope.row.children" :key="item1.id">
              ...
              <el-col :span="19">
                <!-- 嵌套二级权限 -->
                <el-row  class="vcenter" :class="['bdbottom',i2 === 0 ? 'bdtop':'' ]"
        ...
        <el-table-column label="角色操作" width="300px">
          <template slot-scope="scope">
            <el-button @click="editRoles(scope.row)" size="mini"
            type="primary" icon="el-icon-edit">编辑</el-button>
            <el-button size="mini" type="danger"
            icon="el-icon-delete" @click="removeConfirm(scope.row.id)">删除</el-button>
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addRoleCertain">确 定</el-button>
      </span>
    </el-dialog>
    <!-- 分配权限对话框 -->
    <el-dialog
      ...
      show-checkbox node-key="id" ref="treeRef"
    ...
    <el-dialog
      ...
      :model="editRoleForm">
        <el-form-item label="角色名称" prop="roleName">
          <el-input v-model="editRoleForm.roleName" @change="editInput = true"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async removeRightById(role, rightId) {
      ...
      // this.getRolesList()
      // 不要调用getRolesList，会重新渲染整个页面；而仅修改role
    ...
    async showSetRightDialog(role) {
      ...
      // console.log(this.rightsList, role)
      this.setRightDialogVisible = true
    },
    // 通过递归，获取所有三级权限的id，并保存在指定数组中
    getDefKeys(node, arr) {
      if (!node.children) {
    ...
    async allotRight() {
      ...
      var idStr = allotKeys.join(',')
      // console.log(allotKeys, idStr)
